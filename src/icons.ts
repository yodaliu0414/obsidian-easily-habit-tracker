...
export function getCircleIcon(progress: number, color: string): string {
    ...
    return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 ${size} ${size}" style="vertical-align: middle;"><circle cx="${center}" cy="${center}" r="${radius}" stroke="currentColor" stroke-width="1.5" fill="none" opacity="0.2"/><path d="${pathData}" fill="${color}"/></svg>`;
}
...
export function getCompletedCircleIcon(color: string): string {
    const size = 16;
    return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" style="vertical-align: middle; border-radius: 50%;"><circle cx="12" cy="12" r="11" fill="${color}"/><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z" fill="white"/></svg>`;
}
...
export function getFailedCircleIcon(): string {
    ...
    return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" style="vertical-align: middle; border-radius: 50%;"><circle cx="12" cy="12" r="11" fill="${fillColor}" fill-opacity="0.5"/><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12 19 6.41z" fill="white"/></svg>`;
}
...
export function getCompletedSquareIcon(color: string): string {
    const size = 16;
    return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" style="vertical-align: middle;"><rect width="24" height="24" fill="${color}" rx="4"/><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z" fill="white"/></svg>`;
}
...
export function getFailedSquareIcon(): string {
    const size = 16;
    const fillColor = '#cccccc';
    return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" style="vertical-align: middle;"><rect width="24" height="24" fill="${fillColor}" fill-opacity="0.5" rx="4"/><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12 19 6.41z" fill="white"/></svg>`;
}
